...
- 3f6c1f1: fix(sugar-scripts): 修复 Rspack 模式下 externalHelpers 和 DefinePlugin 兼容性问题
...
- fe9f8cd: 修复 Rspack 模式下 externalHelpers 和 DefinePlugin 兼容性问题

## 1.2.0

### Minor Changes

- 8478af2: 支持 Rspack 作为可选构建工具
...
- d230dc5: 支持 windows 下 entryKey 的生成规则
